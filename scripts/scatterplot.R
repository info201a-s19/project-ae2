...
top2018_2017$genre[top2018_2017$genre == "Dance/Electronic"] <- "Dance_Electronic"
top2018_2017$genres <- gsub("-", "", top2018_2017$genre)
top2018_2017$genres <- gsub("/", "", top2018_2017$genre)
top2018_2017$genres <- gsub(" ", "", top2018_2017$genre)
...
genre <- top2018_2017$genres
comparison_scatterplot <- function(element1, element2, dataframe, colorBy) {
  title_label = paste("Influence of", capitalize(element1), "on", capitalize(element2))
  create_scatterplot <- ggplot(dataframe) +
    geom_point(mapping = aes_string(x = element2, y = element1), fill = "blue", alpha = 0.3, size = 5) +
