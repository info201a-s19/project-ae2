...
data_combined <- read.csv("../data/2018_2017_combined.csv", stringsAsFactors = F)
...
plot_combined <- ggplot(data = join_years) +
  geom_col(
...
interactive_plot <- ggplotly(plot_combined, tooltip = c("text"))
